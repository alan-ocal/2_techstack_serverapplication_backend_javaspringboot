...
ALTER TABLE book
    ADD CONSTRAINT fk_author_id FOREIGN KEY IF NOT EXISTS (author_id) REFERENCES author(author_id);
...
ALTER TABLE IF EXISTS review
    ADD COLUMN IF NOT EXISTS book_id INT;
ALTER TABLE IF EXISTS review
    ADD COLUMN IF NOT EXISTS rating INT;
ALTER TABLE review
    ADD CONSTRAINT fk_book_id FOREIGN KEY IF NOT EXISTS (book_id) REFERENCES book(book_id);
